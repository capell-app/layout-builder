...
final class LayoutBuilderActionFactory
{
    ...
    {
        return $this->makeWithLivewire(function (): Action {
    ...
    {
        return $this->makeWithLivewire(fn (): Action => Action::make('undoLayoutMutation')
    ...
    {
        return $this->makeWithLivewire(fn (): Action => Action::make('redoLayoutMutation')
    ...
    {
        return $this->makeWithLivewire(fn (): Action => Action::make('editElementAsset')
     ...
     */
    private function makeWithLivewire(Closure $callback): Action
    {
        $action = $callback->call($this->livewire);
