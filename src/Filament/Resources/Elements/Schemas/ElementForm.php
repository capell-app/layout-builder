...
class ElementForm implements FormConfigurator
{
    public static function configure(Schema $configurator, ?ConfiguratorContextData $context = null): Schema
    {
        ...
        $adminType = $type instanceof Blueprint
            ? $resolver->resolveForType($type, ConfiguratorTypeEnum::Element, DefaultElementConfigurator::getKey())
            : DefaultElementConfigurator::class;
