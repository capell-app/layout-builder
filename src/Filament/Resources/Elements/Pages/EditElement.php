...
class EditElement extends EditRecord
{
    ...
    public function getTitle(): string|Htmlable
    {
        return new HtmlString(
            __('capell-layout-builder::heading.edit_element_record', [
    ...
    public function getSubheading(): string|Htmlable|null
    {
        ...
        if ($type !== null) {
            $subheading .= __('capell-layout-builder::heading.element_type', [
                'type' => $type->name,
            ]);
        }
    ...
    protected function selectChangerItemLabel(Element $model): string
    {
        return $model->name;
    }
