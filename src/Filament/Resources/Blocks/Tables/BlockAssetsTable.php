...
class BlockAssetsTable implements TableConfigurator
{
    public static function configure(Table $table): Table
    {
        return $table
            /** @phpstan-ignore-next-line BlockAsset exposes this local scope through Eloquent. */
            ...
            ->recordUrl(
                fn (BlockAsset $record): ?string => match ($record->asset_type) {
    ...
    private static function createResourcesAction(): Action
    {
        return CreateAction::make()
            ...
            ->using(function (array $data, RelationManager $livewire): Model {
                ...
                throw_if(! $ownerRecord instanceof Block, RuntimeException::class, 'Block assets can only be attached to blocks.');
