...
class BlockSelect extends Select
{
    ...
    protected function setUp(): void
    {
        ...
        $this->label(__('capell-layout-builder::form.select_block'));
    }
        ...
        return $this->model(Widget::class)
            ...
            ->createOptionAction(
                fn (Action $action): Action => $action
                    ->modalHeading(__('capell-layout-builder::generic.block'))
                    ->tooltip(__('capell-layout-builder::button.create_block'))
            ...
            ->editOptionAction(
                fn (Action $action): Action => $action
                    ->modalHeading(function (string $context, self $component, ?int $state): ?HtmlString {
                        ...
                        return new HtmlString(__('capell-layout-builder::heading.edit_block_record', ['name' => $name]));
                    })
                    ->modalWidth(Width::ScreenLarge)
                    ->slideOver()
                    ->successNotificationTitle(
