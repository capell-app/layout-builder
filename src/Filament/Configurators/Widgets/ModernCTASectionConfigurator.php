    ...
    public static function getFormSchema(): array
    {
        return [
            Section::make(__('capell-layout-builder::widgets.common.section_content'))
                ->description(__('capell-layout-builder::widgets.modern.cta_section.section_content_description'))
                ->schema([
                    TextInput::make('data.heading')
                        ->label(__('capell-layout-builder::widgets.modern.cta_section.heading_label'))
                        ->placeholder(__('capell-layout-builder::widgets.modern.cta_section.heading_placeholder'))
                        ->required()
                        ->maxLength(100)
                        ->columnSpanFull(),

                    Textarea::make('data.subheading')
                        ->label(__('capell-layout-builder::widgets.modern.cta_section.subheading_label'))
                        ->placeholder(__('capell-layout-builder::widgets.modern.cta_section.subheading_placeholder'))
                        ->rows(2)
                        ->maxLength(300)
                        ->columnSpanFull(),
                    ...
                    Group::make()
                        ->schema([
                            TextInput::make('data.primaryButton.label')
                                ...
                                ->placeholder(__('capell-layout-builder::widgets.modern.cta_section.primary_button_label_placeholder'))
                                ->required()
                                ->maxLength(50),

                            TextInput::make('data.primaryButton.url')
                                ->label(__('capell-layout-builder::widgets.common.button_url'))
                                ->placeholder(__('capell-layout-builder::widgets.modern.cta_section.primary_button_url_placeholder'))
                                ->required()
                                ->url(),

                            TextInput::make('data.primaryButton.icon')
                                ->label(__('capell-layout-builder::widgets.common.button_icon'))
                                ->placeholder(__('capell-layout-builder::widgets.modern.cta_section.primary_button_icon_placeholder'))
                                ->maxLength(2),
                    ...
                    Group::make()
                        ->schema([
                            TextInput::make('data.secondaryButton.label')
                                ->label(__('capell-layout-builder::widgets.common.button_label'))
                                ->placeholder(__('capell-layout-builder::widgets.modern.cta_section.secondary_button_label_placeholder')),

                            TextInput::make('data.secondaryButton.url')
                                ->label(__('capell-layout-builder::widgets.common.button_url'))
                                ->placeholder(__('capell-layout-builder::widgets.modern.cta_section.secondary_button_url_placeholder'))
                                ->url(),
                        ])->columns(2)->columnSpanFull(),
                ])->columns(2),

            Section::make(__('capell-layout-builder::widgets.common.section_layout_styling'))
                ->description(__('capell-layout-builder::widgets.common.section_layout_styling_description'))
                ->schema([
                    ...
                    TextInput::make('data.backgroundGradient')
                        ...
                        ->helperText(__('capell-layout-builder::widgets.common.background_gradient_helper'))
                        ->columnSpanFull(),
                ])->columns(2),
