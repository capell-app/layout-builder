    ...
    public static function getFormSchema(): array
    {
        return [
            Section::make(__('capell-layout-builder::widgets.common.section_content'))
                ->description(__('capell-layout-builder::widgets.modern.image_gallery.section_content_description'))
                ->schema([
                    TextInput::make('data.title')
                        ->label(__('capell-layout-builder::widgets.common.section_title_label'))
                        ->placeholder(__('capell-layout-builder::widgets.modern.image_gallery.title_placeholder'))
                        ->columnSpanFull(),

                    TextInput::make('data.subtitle')
                        ->label(__('capell-layout-builder::widgets.common.subtitle_label'))
                        ->placeholder(__('capell-layout-builder::widgets.modern.image_gallery.subtitle_placeholder'))
                        ->columnSpanFull(),
                ])->columns(1),

            Section::make(__('capell-layout-builder::widgets.common.section_layout'))
                ->description(__('capell-layout-builder::widgets.modern.image_gallery.section_layout_description'))
                ->schema([
