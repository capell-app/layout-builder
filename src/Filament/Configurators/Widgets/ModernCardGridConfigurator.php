...
class ModernCardGridConfigurator
{
    ...
    {
        return [
            Section::make(__('capell-layout-builder::widgets.common.section_header'))
                ->description(__('capell-layout-builder::widgets.modern.card_grid.section_header_description'))
                ->schema([
                    TextInput::make('data.title')
                        ->label(__('capell-layout-builder::widgets.common.section_title_label'))
                        ->placeholder(__('capell-layout-builder::widgets.modern.card_grid.title_placeholder'))
                        ->maxLength(100),

                    Textarea::make('data.description')
                        ->label(__('capell-layout-builder::widgets.modern.card_grid.description_label'))
                        ->placeholder(__('capell-layout-builder::widgets.modern.card_grid.description_placeholder'))
                        ->rows(2),
                ])->columns(2),

            Section::make(__('capell-layout-builder::widgets.common.section_cards'))
                ->description(__('capell-layout-builder::widgets.common.section_cards_description'))
                ->schema([
                    Repeater::make('data.cards')
                        ->label(__('capell-layout-builder::widgets.modern.card_grid.cards_label'))
                        ->schema([
                            TextInput::make('icon')
                                ->label(__('capell-layout-builder::widgets.modern.card_grid.card_icon_label'))
                                ->placeholder('🎨')
                                ->maxLength(2)
                                ->helperText(__('capell-layout-builder::widgets.modern.card_grid.card_icon_helper')),

                            TextInput::make('title')
                                ->label(__('capell-layout-builder::widgets.modern.card_grid.card_title_label'))
                                ->placeholder(__('capell-layout-builder::widgets.modern.card_grid.card_title_placeholder'))
                                ->required()
                                ->maxLength(50),

                            Textarea::make('description')
                                ->label(__('capell-layout-builder::widgets.modern.card_grid.card_description_label'))
                                ->placeholder(__('capell-layout-builder::widgets.modern.card_grid.card_description_placeholder'))
                                ->rows(2)
                                ->maxLength(200),

                            TextInput::make('image')
                                ->label(__('capell-layout-builder::widgets.modern.card_grid.card_image_label'))
                                ->placeholder(__('capell-layout-builder::widgets.modern.card_grid.card_image_placeholder'))
                                ->url()
                                ->helperText(__('capell-layout-builder::widgets.modern.card_grid.card_image_helper')),

                            TextInput::make('badge')
                                ->label(__('capell-layout-builder::widgets.modern.card_grid.card_badge_label'))
                                ->placeholder(__('capell-layout-builder::widgets.modern.card_grid.card_badge_placeholder'))
                                ->maxLength(30)
                                ->helperText(__('capell-layout-builder::widgets.modern.card_grid.card_badge_helper')),

                            TextInput::make('link.label')
                                ->label(__('capell-layout-builder::widgets.modern.card_grid.card_link_label'))
                                ->placeholder(__('capell-layout-builder::widgets.modern.card_grid.card_link_placeholder'))
                                ->maxLength(30),

                            TextInput::make('link.url')
                                ->label(__('capell-layout-builder::widgets.modern.card_grid.card_link_url_label'))
                                ->placeholder(__('capell-layout-builder::widgets.modern.card_grid.card_link_url_placeholder'))
                                ->url(),
                        ])
                        ->columns(2)
                        ->defaultItems(3)
                        ->minItems(1)
                        ->maxItems(12)
                        ->addActionLabel(__('capell-layout-builder::widgets.modern.card_grid.add_card')),
                ])->columns(1),

            Section::make(__('capell-layout-builder::widgets.common.section_layout'))
                ->description(__('capell-layout-builder::widgets.modern.card_grid.section_layout_description'))
                ->schema([
