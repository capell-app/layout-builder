    ...
    public static function getFormSchema(): array
    {
        return [
            Section::make(__('capell-layout-builder::widgets.common.section_content'))
                ->description(__('capell-layout-builder::widgets.modern.process_steps.section_content_description'))
                ->schema([
                    TextInput::make('data.title')
                        ->label(__('capell-layout-builder::widgets.common.section_title_label'))
                        ->placeholder(__('capell-layout-builder::widgets.modern.process_steps.title_placeholder'))
                        ->columnSpanFull(),

                    TextInput::make('data.subtitle')
                        ->label(__('capell-layout-builder::widgets.common.subtitle_label'))
                        ->placeholder(__('capell-layout-builder::widgets.modern.process_steps.subtitle_placeholder'))
                        ->columnSpanFull(),
                ])->columns(1),

            Section::make(__('capell-layout-builder::widgets.common.section_layout'))
                ->description(__('capell-layout-builder::widgets.modern.process_steps.section_layout_description'))
                ->schema([
                    Select::make('data.layout')
                        ->label(__('capell-layout-builder::widgets.modern.process_steps.layout_label'))
                        ->options([
                            'horizontal' => __('capell-layout-builder::widgets.modern.process_steps.layout_horizontal'),
                            'vertical' => __('capell-layout-builder::widgets.modern.process_steps.layout_vertical'),
                        ])
                        ->default('horizontal')
                        ->helperText(__('capell-layout-builder::widgets.modern.process_steps.layout_helper')),
                ])->columns(1),
