    ...
    public static function getFormSchema(): array
    {
        return [
            Section::make(__('capell-layout-builder::widgets.common.section_content'))
                ->description(__('capell-layout-builder::widgets.modern.pricing_table.section_content_description'))
                ->schema([
                    TextInput::make('data.title')
                        ->label(__('capell-layout-builder::widgets.common.section_title_label'))
                        ->placeholder(__('capell-layout-builder::widgets.modern.pricing_table.title_placeholder'))
                        ->columnSpanFull(),

                    TextInput::make('data.currency')
                        ->label(__('capell-layout-builder::widgets.modern.pricing_table.currency_label'))
                        ->placeholder(__('capell-layout-builder::widgets.modern.pricing_table.currency_placeholder'))
                        ->maxLength(5)
                        ->default('$'),
