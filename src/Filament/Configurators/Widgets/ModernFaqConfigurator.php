    ...
    public static function getFormSchema(): array
    {
        return [
            Section::make(__('capell-layout-builder::widgets.common.section_content'))
                ->description(__('capell-layout-builder::widgets.modern.faq.section_content_description'))
                ->schema([
                    TextInput::make('data.title')
                        ->label(__('capell-layout-builder::widgets.common.section_title_label'))
                        ->placeholder(__('capell-layout-builder::widgets.modern.faq.title_placeholder'))
                        ->columnSpanFull(),

                    Repeater::make('data.categories')
                        ->label(__('capell-layout-builder::widgets.modern.faq.categories_label'))
                        ->schema([
                            TextInput::make('name')
                                ->label(__('capell-layout-builder::widgets.modern.faq.category_name_label'))
                                ->placeholder(__('capell-layout-builder::widgets.modern.faq.category_name_placeholder'))
                                ->required()
                                ->maxLength(50),
                        ])
                        ->columns(1)
                        ...
                        ->minItems(0)
                        ->maxItems(10)
                        ->addActionLabel(__('capell-layout-builder::widgets.modern.faq.add_category')),
                ])->columns(1),
