...
/**
 * @extends Factory<BlockAsset>
 */
class BlockAssetFactory extends Factory
{
    protected $model = BlockAsset::class;
    ...
    public function widget(Block $block): self
    {
    ...
    {
        return $this->afterCreating(function (BlockAsset $blockAsset) use ($mediaCount, $collection): void {
            Media::factory()
                ->count($mediaCount)
