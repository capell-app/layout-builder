...
use Capell\LayoutBuilder\Database\Factories\BlockAssetFactory;
 ...
 */
class BlockAsset extends Model implements HasMedia, Userstampable
{
    use ComposhipsJsonRelationshipsTrait;
    use HasAssets;
    use HasCapellMedia;

    /** @use HasFactory<BlockAssetFactory> */
    use HasFactory;

    use HasMetaData;
    use HasUserstamps;

    protected $table = 'block_assets';
    ...
    protected static string $factory = BlockAssetFactory::class;
    ...
    {
        $value = $this->attributes['block_id'] ?? null;
