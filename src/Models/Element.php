...
class Element extends Model implements Blueprintable, HasMedia, Publishable, Statusable, Translatable, Userstampable
{
    use Cloneable;
    use HasBlueprint;
    use HasCapellMedia;
    ...
    public function getComponent(): ?string
    {
        return ResolveRenderableComponentAction::run(
            RenderableTypeEnum::Element,
            $this->getMetaComponent() ?? config('capell-layout-builder.default_element', 'capell.element.default'),
