# Mosaic Widget Reference

This focused guide extends [Overview](overview.md) for the Mosaic package.

## Purpose

Mosaic owns reusable widgets, sections, widget assets, and layout container placement.
...
- Campaign and Blog packages can register Mosaic-aware widget configurators.
...
- Register widget types in Mosaic service provider registration.
