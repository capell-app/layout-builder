...
namespace Capell\Backup\Filament\Pages;
 ...
 * a clear placeholder exception until the backup package provides it.
 */
class ImportSitesPage extends Page
{
    ...
    {
        throw new RuntimeException('Site imports are provided by the backup package.');
    }
}
