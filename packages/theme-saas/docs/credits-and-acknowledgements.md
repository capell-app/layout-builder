# Theme SaaS Credits And Acknowledgements
...
Package role: Conversion-led SaaS renderer for Capell Theme Studio
...
- [Capell Core](https://docs.capell.app) supplies the Capell-side contracts, surfaces, or runtime that Theme SaaS builds on.
- [Foundation Theme](../../foundation-theme/README.md) supplies the Capell-side contracts, surfaces, or runtime that Theme SaaS builds on.
- [Theme Studio Core](../../theme-studio-core/README.md) supplies the Capell-side contracts, surfaces, or runtime that Theme SaaS builds on.
