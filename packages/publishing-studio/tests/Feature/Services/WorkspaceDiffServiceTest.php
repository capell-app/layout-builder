...
it('dashboard-dashboard_reports modified rows with only changed attributes', function (): void {
...
it('dashboard-dashboard_reports added rows with no live counterpart', function (): void {
    $workspace = Workspace::factory()->open()->create();
