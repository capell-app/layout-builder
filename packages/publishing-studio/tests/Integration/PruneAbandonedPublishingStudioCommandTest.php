...
it('prunes abandoned publishing-studio, clears shadowed live rows, and deletes draft rows', function (): void {
    ...
    $exitCode = Artisan::call('capell:publishing-studio:prune');
...
it('dry-run leaves data untouched', function (): void {
    ...
    $exitCode = Artisan::call('capell:publishing-studio:prune', ['--dry-run' => true]);
...
it('can prune a specific workspace id regardless of status', function (): void {
    ...
    $exitCode = Artisan::call('capell:publishing-studio:prune', ['--id' => [$openWorkspace->id]]);
