# Insights Credits And Acknowledgements

Insights is part of the Capell package set. This page names the main frameworks, packages, authors, and services this package leans on, with a short note about what they make possible here. It is intentionally shorter than the repository-wide credits page and closer to the package itself.

Package role: First-party insights, visitor journeys, click tracking, and consent management.
...
- [Capell Admin](https://docs.capell.app) supplies the Capell-side contracts, surfaces, or runtime that Insights builds on.
- [Capell Core](https://docs.capell.app) supplies the Capell-side contracts, surfaces, or runtime that Insights builds on.
- [Capell Frontend](https://docs.capell.app) supplies the Capell-side contracts, surfaces, or runtime that Insights builds on.
...
Insights is useful because consent is part of the package, not an afterthought. Journey, click, and event tracking can be improved while keeping retention and consent behaviour visible.

## Keeping This Page Current

When Insights adds a new framework, service, or third-party package that becomes part of the user-facing workflow, update this page and the package README together. Credits should explain the practical help we get from a dependency, not just list a package name.
