...
return new class extends Migration
{
    ...
    {
        $tableName = config('capell-campaign-studio.tables.landing_pages', 'campaign_landing_pages');
    ...
    {
        Schema::dropIfExists(config('capell-campaign-studio.tables.landing_pages', 'campaign_landing_pages'));
    }
};
