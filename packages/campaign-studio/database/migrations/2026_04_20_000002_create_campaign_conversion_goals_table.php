...
return new class extends Migration
{
    ...
    {
        $tableName = config('capell-campaign-studio.tables.conversion_goals', 'campaign_conversion_goals');
    ...
    {
        Schema::dropIfExists(config('capell-campaign-studio.tables.conversion_goals', 'campaign_conversion_goals'));
    }
};
