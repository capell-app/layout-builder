    ...
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-10 lg:grid-cols-6">
            ...
            <div class="lg:col-span-2">
                ...
                <p class="mt-3 max-w-xs text-sm text-[var(--color-fg-muted)]">{{ $tagline }}</p>

                @if ($showNewsletter === 'yes')
                    <form class="mt-6 max-w-sm" aria-label="Newsletter signup" action="#" method="post">
                        <label for="saas-footer-newsletter" class="text-xs font-semibold uppercase tracking-widest text-[var(--color-fg-muted)]">
                            Get product updates
                        </label>
                        <div class="mt-2 flex gap-2">
                            <input id="saas-footer-newsletter"
                                   type="email"
                                   name="email"
                                   required
                                   autocomplete="email"
            ...
            @foreach ($columns as $column)
                <nav aria-label="{{ $column['heading'] ?? 'Footer column' }}" class="lg:col-span-1">
                    <h2 class="text-xs font-semibold uppercase tracking-widest text-[var(--color-fg)]">
                        {{ $column['heading'] ?? '' }}
                    </h2>
        ...
        <div class="mt-12 flex flex-wrap items-center justify-between gap-4 border-t border-[var(--color-border)] pt-6">
