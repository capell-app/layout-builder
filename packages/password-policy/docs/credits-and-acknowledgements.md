# Password Policy Credits And Acknowledgements
...
- [Capell Admin](https://docs.capell.app) supplies the Capell-side contracts, surfaces, or runtime that Password Policy builds on.
- [Capell Core](https://docs.capell.app) supplies the Capell-side contracts, surfaces, or runtime that Password Policy builds on.
