# Theme Studio Admin Credits And Acknowledgements

Theme Studio Admin is part of the Capell package set. This page names the main frameworks, packages, authors, and services this package leans on, with a short note about what they make possible here. It is intentionally shorter than the repository-wide credits page and closer to the package itself.

Package role: Dedicated Filament admin experience for Capell Theme Studio
...
- [Capell Admin](https://docs.capell.app) supplies the Capell-side contracts, surfaces, or runtime that Theme Studio Admin builds on.
- [Capell Core](https://docs.capell.app) supplies the Capell-side contracts, surfaces, or runtime that Theme Studio Admin builds on.
- [Theme Studio Core](../../theme-studio-core/README.md) supplies the Capell-side contracts, surfaces, or runtime that Theme Studio Admin builds on.
...
Theme Studio Admin is useful because theme changes get a proper admin workflow. Staging, previewing, readiness checks, labels, and activation can be fixed without touching renderer internals.

## Keeping This Page Current

When Theme Studio Admin adds a new framework, service, or third-party package that becomes part of the user-facing workflow, update this page and the package README together. Credits should explain the practical help we get from a dependency, not just list a package name.
