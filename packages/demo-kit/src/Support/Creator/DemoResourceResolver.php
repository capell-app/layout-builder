...
final class DemoResourceResolver
{
    ...
    public function ensureStorageDemoResources(): string
    {
        ...
        try {
            ...
            $archiveUrl = config('capell-demo-kit.archive.url', 'https://capell.app/demo.zip');
    ...
    {
        $configured = config('capell-demo-kit.archive.max_bytes', 52428800);
    ...
    {
        $expectedChecksum = config('capell-demo-kit.archive.checksum');
