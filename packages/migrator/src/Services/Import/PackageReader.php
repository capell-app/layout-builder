...
final class PackageReader
{
    ...
    {
        $maxBytes = $this->configuredByteLimit('migrator.limits.max_metadata_json_bytes', 1024 * 1024);
    ...
    {
        $maxBytes = $this->configuredByteLimit('migrator.limits.max_payload_json_bytes', 5 * 1024 * 1024);
    ...
    {
        $maxBytes = $this->configuredByteLimit('migrator.limits.max_media_bytes', 50 * 1024 * 1024);
    ...
    {
        $maxBytes = $this->configuredByteLimit('migrator.limits.max_package_uncompressed_bytes', 250 * 1024 * 1024);
