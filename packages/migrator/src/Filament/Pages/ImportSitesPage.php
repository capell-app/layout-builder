...
namespace Capell\Migrator\Filament\Pages;
 ...
 * a clear placeholder exception until the migrator package provides it.
 */
class ImportSitesPage extends Page
{
    ...
    {
        throw new RuntimeException('Site imports are provided by the migrator package.');
    }
}
