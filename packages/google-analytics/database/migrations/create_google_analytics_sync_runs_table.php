...
return new class extends Migration
{
    ...
    {
        $tableName = config('capell-google-analytics.tables.sync_runs', 'google_analytics_sync_runs');
    ...
    {
        Schema::dropIfExists(config('capell-google-analytics.tables.sync_runs', 'google_analytics_sync_runs'));
    }
};
