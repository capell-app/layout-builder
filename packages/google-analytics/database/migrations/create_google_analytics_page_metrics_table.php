...
return new class extends Migration
{
    ...
    {
        $tableName = config('capell-google-analytics.tables.page_metrics', 'google_analytics_page_metrics');
    ...
    {
        Schema::dropIfExists(config('capell-google-analytics.tables.page_metrics', 'google_analytics_page_metrics'));
    }
};
