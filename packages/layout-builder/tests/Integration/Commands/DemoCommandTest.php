...
it('runs the demo command and creates demo layouts for a site', function (): void {
    ...
    $sourceDemoDirectory = realpath(__DIR__ . '/../../../../../packages/starter-sites/demo');
    ...
    artisan('capell:layout-builder-demo', [
        '--sites' => $site->name,
    ])
...
it('runs layout-builder demo with --skip-hero without delegating to hero demo', function (): void {
    $capellDirectory = storage_path('app/capell');
    $demoDirectory = $capellDirectory . '/demo';
...
it('runs layout-builder demo when no pages with images exist yet', function (): void {
    $capellDirectory = storage_path('app/capell');
    $demoDirectory = $capellDirectory . '/demo';
