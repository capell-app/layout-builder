...
it('dashboard-dashboard_reports the created view path and prints the seeder snippet', function (): void {
    File::delete(resource_path('views/widgets/hero-banner.blade.php'));

    artisan('capell:layout-builder-make-widget', ['name' => 'HeroBanner'])
...
it('supports livewire widget scaffolding', function (): void {
    ...
    artisan('capell:layout-builder-make-widget', ['name' => 'CardPromo', '--livewire' => true])
