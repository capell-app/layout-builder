...
test('can sync new section and page assets to widget in page layout context', function (): void {
    ...
    livewire(LayoutBuilder::class, [
        ...
        ->call(
            ...
            type: Capell\LayoutBuilder\Enums\AssetEnum::Section->value,
...
test('can reorder assets', function (): void {
    ...
    $secondAsset = WidgetAsset::factory()
        ->widget($widget)
        ->asset(Capell\LayoutBuilder\Enums\AssetEnum::Section)
        ->state([
            'order' => 2,
            'occurrence' => 2,
        ])
...
test('can select all widget assets', function (): void {
    ...
    foreach ([AssetEnum::Page, Capell\LayoutBuilder\Enums\AssetEnum::Section] as $assetType) {
        WidgetAsset::factory()
            ->count(2)
            ->widget($widget)
            ->asset($assetType)
