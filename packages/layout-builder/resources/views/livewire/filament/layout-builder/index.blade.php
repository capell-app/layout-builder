            ...
            >
                ...
                <div class="ml-auto mt-auto space-y-4 text-right">
                                ...
                                >
                                    ...
                                    <x-filament::dropdown.list>
                                        ...
                                        <x-filament::dropdown.list.item
                                            ...
                                            tag="a"
                                        >
                                            {{ __('capell-layout-builder::button.open_edit_layout') }}
                                        </x-filament::dropdown.list.item>
                                    </x-filament::dropdown.list>
                                </x-filament::dropdown>
                            </div>
                    ...
                    <div class="flex flex-wrap items-center justify-end gap-2">
                        ...
                        >
                            {{ __('capell-layout-builder::button.open_widget_palette') }}
                        </x-filament::button>
                ...
                >
                    <div class="mb-3 flex items-center justify-between gap-3">
                        <div>
                            ...
                            >
                                {{ __('capell-layout-builder::form.widget_palette') }}
                            </h2>

                            <span
                                class="text-xs text-gray-500 dark:text-gray-400"
                            >
                                {{ __('capell-layout-builder::message.widget_palette_count', ['count' => $widgetPalette->total()]) }}
                            </span>
                        </div>
                    ...
                    >
                        <x-filament::input
                            ...
                            :placeholder="__('capell-layout-builder::form.search_widgets')"
                        />
                    </x-filament::input.wrapper>
                    ...
                    >
                        ...
                        @empty
                            ...
                            >
                                {{ __('capell-layout-builder::message.widget_palette_empty') }}
                            </div>
                        @endforelse
                    </div>
                    ...
                    <div class="mt-3 flex items-center justify-between gap-2">
                        ...
                        >
                            {{ __('capell-layout-builder::button.previous') }}
                        </x-filament::button>

                        <span class="text-xs text-gray-500 dark:text-gray-400">
                            {{ __('capell-layout-builder::message.widget_palette_page', ['current' => $widgetPalette->currentPage(), 'last' => $widgetPalette->lastPage()]) }}
                        </span>
                        ...
                        >
                            {{ __('capell-layout-builder::button.next') }}
                        </x-filament::button>
                    </div>
                </aside>
            </div>
