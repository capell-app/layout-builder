...
namespace Capell\StarterSites\Support\Creator;
...
final class DemoResourceResolver
{
    ...
    public function ensureStorageDemoResources(): string
    {
        ...
        try {
            ...
            $archiveUrl = config('capell-starter-sites.archive.url', 'https://capell.app/demo.zip');
    ...
    {
        $configured = config('capell-starter-sites.archive.max_bytes', 52428800);
    ...
    {
        $expectedChecksum = config('capell-starter-sites.archive.checksum');
