...
return new class extends Migration
{
    ...
    {
        $tableName = config('capell-ga4-reports.tables.daily_metrics', 'ga4_reports_daily_metrics');
    ...
    {
        Schema::dropIfExists(config('capell-ga4-reports.tables.daily_metrics', 'ga4_reports_daily_metrics'));
    }
};
