    ...
    extend: {
      colors: {
        mosaic: {
          ...
          'surface-container-lowest': 'var(--mosaic-surface-container-lowest)',
          'surface-container-low': 'var(--mosaic-surface-container-low)',
          'surface-container': 'var(--mosaic-surface-container)',
          'surface-container-high': 'var(--mosaic-surface-container-high)',
          'surface-container-highest': 'var(--mosaic-surface-container-highest)',
          ...
          'on-success-container': 'var(--mosaic-on-success-container)',

          warning: 'var(--mosaic-warning)',
          'warning-container': 'var(--mosaic-warning-container)',
          'on-warning': 'var(--mosaic-on-warning)',
          'on-warning-container': 'var(--mosaic-on-warning-container)',
      ...
      backgroundImage: {
        'mosaic-primary-gradient': 'linear-gradient(135deg, var(--mosaic-primary-container) 0%, #5a00c6 100%)',
        'mosaic-secondary-gradient': 'linear-gradient(135deg, var(--mosaic-secondary-container) 0%, #3131c0 100%)',
        'mosaic-tertiary-gradient': 'linear-gradient(135deg, var(--mosaic-tertiary) 0%, var(--mosaic-tertiary-container) 100%)',
      },
    },
  },
