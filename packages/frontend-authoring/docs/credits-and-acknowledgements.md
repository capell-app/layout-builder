# Frontend Authoring Credits And Acknowledgements
...
- [Capell Admin](https://docs.capell.app) supplies the Capell-side contracts, surfaces, or runtime that Frontend Authoring builds on.
- [Capell Frontend](https://docs.capell.app) supplies the Capell-side contracts, surfaces, or runtime that Frontend Authoring builds on.
